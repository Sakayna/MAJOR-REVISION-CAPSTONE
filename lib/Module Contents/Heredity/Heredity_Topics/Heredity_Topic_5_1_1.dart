...
class Heredity_Topic_5_1_1 extends StatefulWidget {
  @override
  _Heredity_Topic_5_1_1State createState() => _Heredity_Topic_5_1_1State();
}
...
class _Heredity_Topic_5_1_1State extends State<Heredity_Topic_5_1_1> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset(
      'assets/videos/heredity/sexual_reproduction.mp4',
    )..initialize().then((_) {
        setState(() {});
      });
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 30),
                              Text(
                                'Watch this video to learn more about Sexual Reproduction in Humans:',
                                style: TextStyle(fontSize: 14),
                              ),
                              SizedBox(height: 16),
                              buildVideoPlayer(
                              ...
                              SizedBox(height: 10),
                              Text(
                                'Reference: https://youtu.be/-ekRRuSa_UQ',
                                style: TextStyle(
                                  fontSize: 12,
