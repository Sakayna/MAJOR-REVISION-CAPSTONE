...
class Heredity_AT_5_1 extends StatelessWidget {
  @override
                            ...
                            children: [
                                ...
                                child: Row(
                                  children: [
                                    Icon(
                                      Icons.quiz,
                                      color: Color(
                                          0xFF64B6AC), // Set icon color to match app theme
                              ...
                              Padding(
                                padding: const EdgeInsets.all(
                                    8.0), // Add padding around the text
                                child: Text(
                                  'Instructions: Determine whether the provided image depicts asexual or sexual reproduction. Carefully analyze the image and use your knowledge to make the correct identification.',
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            Heredity_AT_Quiz_0_Content(),
                                      ),
                                    );
                                  },
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Color(
                                        0xFF64B6AC), // Set button color to match app theme
          ...
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Opacity(
                  opacity: globalVariables.getQuizTaken('lesson5', 'quiz1')
                      ? 1.0
                      : 0.5,
                  child: FloatingActionButton(
                    onPressed: () {
                      if (globalVariables.getQuizTaken('lesson5', 'quiz1')) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
