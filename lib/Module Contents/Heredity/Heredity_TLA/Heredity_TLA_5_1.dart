...
class Heredity_TLA_5_1 extends StatelessWidget {
  @override
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Learn about Asexual and Sexual Reproduction',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14.0,
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            'In this Teaching Learning Activity, you will explore the different types of asexual and sexual reproduction. Follow the instructions to understand how each type occurs and the key differences between them.',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12.0,
                            ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage('assets/lesson7/AR7.png'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
