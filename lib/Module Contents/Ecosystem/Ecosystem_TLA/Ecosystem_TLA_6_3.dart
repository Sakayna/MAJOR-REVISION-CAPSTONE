...
class Ecosystem_TLA_6_3 extends StatelessWidget {
  @override
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Learn about the effect of changes in one population on other populations in the ecosystem',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14.0,
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            'In this Teaching Learning Activity, you will explore how changes in one population can impact others within an ecosystem. Follow the instructions to understand how species interact and how shifts in population sizes can alter the balance of the entire ecosystem.',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12.0,
                            ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ModuleScreen11(),
                            ),
                          );
                        },
                        child: Container(
