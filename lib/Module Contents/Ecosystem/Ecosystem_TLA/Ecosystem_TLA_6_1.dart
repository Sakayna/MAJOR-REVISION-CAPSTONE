...
class Ecosystem_TLA_6_1 extends StatelessWidget {
  @override
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Learn about Biotic and Abiotic',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14.0,
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            'In this Teaching Learning Activity, you will explore the differences between biotic and abiotic components of ecosystems. Follow the instructions to understand how living organisms (biotic) differ from non-living elements (abiotic) and how each plays a unique role in the environment.',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12.0,
                            ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage('assets/lesson9/AR9.png'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
