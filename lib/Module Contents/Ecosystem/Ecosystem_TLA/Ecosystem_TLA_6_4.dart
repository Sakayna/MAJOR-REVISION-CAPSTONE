...
import 'package:capstone/pages/TLA/Week%2012/predict12.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:capstone/globals/global_variables_notifier.dart';

class Ecosystem_TLA_6_4 extends StatelessWidget {
  @override
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Learn about the effect of changes in abiotic factors on the ecosystem',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14.0,
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            'In this Teaching Learning Activity, you will learn about how environmental factors like water, sunlight, pollution, deforestation, and water temperature changes impact ecosystem balance.',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12.0,
                            ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ModuleScreen12(),
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage('assets/lesson12/AR12.png'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
