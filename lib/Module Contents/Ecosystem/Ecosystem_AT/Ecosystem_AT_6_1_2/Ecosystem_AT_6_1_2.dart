...
class Ecosystem_AT_6_1_2 extends StatelessWidget {
  @override
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(
                                    8.0), // Add padding around the text
                                child: Text(
                                  'Instructions: In this assessment, your task is to determine whether the provided image depicts a predator or prey. Carefully review the image and use your knowledge of ecosystems to make the correct identification.',
          ...
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Opacity(
                  opacity: globalVariables.getQuizTaken('lesson6', 'quiz2')
                      ? 1.0
                      : 0.5,
                  child: FloatingActionButton(
                    onPressed: () {
                      if (globalVariables.getQuizTaken('lesson6', 'quiz2')) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
