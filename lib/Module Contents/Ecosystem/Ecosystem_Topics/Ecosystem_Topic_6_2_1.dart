...
class Ecosystem_Topic_6_2_1 extends StatelessWidget {
  @override
                          ...
                          children: [
                            if (!isTop) ...[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  '6.2.1 - Climatic Factors', // Additional text for the appbar
                                  style: TextStyle(
                                    fontSize: 12.0,
                                    fontWeight: FontWeight.w600,
                                    color:
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      'Watch this video to learn more about the Climate Factors',
                                      style: TextStyle(fontSize: 14),
                                    ),
                                  ),
                                  TextButton(
                                    onPressed: () {
                                      launch(
                                          'https://youtu.be/wAPpAxfsars?si=L0Mz59MM3dxlzbNy');
                                    },
                                    child: Text(
